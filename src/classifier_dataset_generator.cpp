...
void ClassifierDatasetGenerator::datasetGenerationInit() {
...
void ClassifierDatasetGenerator::generateDataset() {
...
void ClassifierDatasetGenerator::readTrainDataset(std::vector<Pose> &gtPoses, std::vector<Pose> &successPoses, std::vector<Pose> &failurePoses,
...
void ClassifierDatasetGenerator::readTestDataset(std::vector<Pose> &gtPoses, std::vector<Pose> &successPoses, std::vector<Pose> &failurePoses,
    std::vector<sensor_msgs::LaserScan> &scans, std::vector<std::vector<double>> &successResidualErrors, std::vector<std::vector<double>> &failureResidualErrors)
{
    readDataset(testDirs_, gtPoses, successPoses, failurePoses, scans, successResidualErrors, failureResidualErrors);
}

void ClassifierDatasetGenerator::mapCB(const nav_msgs::OccupancyGrid::ConstPtr &msg) {
    map_ = *msg;
...
std::vector<Obstacle> ClassifierDatasetGenerator::generateObstacles(void) {
...
nav_msgs::OccupancyGrid ClassifierDatasetGenerator::buildSimulationMap(std::vector<Obstacle> obstacles) {
...
void ClassifierDatasetGenerator::generatePoses(Pose &gtPose, Pose &successPose, Pose &failurePose) {
    for (;;) {
...
sensor_msgs::LaserScan ClassifierDatasetGenerator::simulateScan(Pose gtPose, nav_msgs::OccupancyGrid simMap) {
...
bool ClassifierDatasetGenerator::isValidScan(sensor_msgs::LaserScan scan) {
    int validScanNum = 0;
...
std::vector<double> ClassifierDatasetGenerator::getResidualErrors(Pose pose, sensor_msgs::LaserScan scan) {
...
void ClassifierDatasetGenerator::saveData(Pose gtPose, Pose successPose, Pose failurePose, sensor_msgs::LaserScan scan, std::vector<double> successResidualErrors, std::vector<double> failureResidualErrors) {
...
void ClassifierDatasetGenerator::readDataset(std::vector<std::string> dirs, std::vector<Pose> &gtPoses, std::vector<Pose> &successPoses, std::vector<Pose> &failurePoses,
    std::vector<sensor_msgs::LaserScan> &scans, std::vector<std::vector<double>> &successResidualErrors, std::vector<std::vector<double>> &failureResidualErrors)
{
    FILE *fp;
    std::string fname;
