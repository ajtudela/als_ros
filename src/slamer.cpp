...
SLAMER::SLAMER(std::string ismYamlFile):
    nh_("~"),
...
void SLAMER::calculateLikelihoodsBySLAMER(void) {
    scan_ = getScan();
...
void SLAMER::recognizeObjectsWithMapAssist(void) {
...
void SLAMER::publishSLAMERROSMessages(void) {
    if (publishColoredScanPoints_) {
...
double SLAMER::calculateLineObjectClassificationModel(std::vector<double> classificationProbs, int objectID) {
...
double SLAMER::calculateSpatialLineObjectClassificationModel(std::vector<double> classificationProbs, int objectID) {
...
double SLAMER::calculateLikelihoodFieldModel(double dist) {
...
std::vector<double> SLAMER::getLineObjectPrior(Pose sensorPose, LineObject lineObject) {
...
std::vector<double> SLAMER::getSpatialLineObjectPrior(Pose sensorPose, LineObject spatialLineObject) {
