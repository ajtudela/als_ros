...
cv::Mat GLPoseSampler::buildDistanceFieldMap(nav_msgs::OccupancyGrid map) {
...
std::vector<Keypoint> GLPoseSampler::detectKeypoints(nav_msgs::OccupancyGrid map, cv::Mat distMap) {
