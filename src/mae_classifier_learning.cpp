...
std::vector<double> MAEClassifier::readMAEs(std::string filePath) {
...
double MAEClassifier::getMAE(std::vector<double> residualErrors) {
    double sum = 0.0;
    int num = 0;
...
void MAEClassifier::learnThreshold(std::vector<std::vector<double>> trainSuccessResidualErrors, std::vector<std::vector<double>> trainFailureResidualErrors) {
...
void MAEClassifier::writeClassifierParams(std::vector<std::vector<double>> testSuccessResidualErrors, std::vector<std::vector<double>> testFailureResidualErrors) {
...
void MAEClassifier::readClassifierParams(void) {
    std::string yamlFile = classifiersDir_ + "classifier.yaml";
...
double MAEClassifier::calculateDecisionModel(double mae, double *reliability) {
...
void MAEClassifier::writeDecisionLikelihoods(void) {
